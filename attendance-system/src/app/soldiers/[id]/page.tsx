...
export default function SoldierProfilePage() {
  ...
  if (!soldier) {
    return (
      <div className="rounded-lg border border-sky-300 bg-sky-100 p-6">
    ...
    <div>
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-2">
          <Link
            href="/soldiers"
            className="rounded-md border border-sky-300 bg-sky-100 px-3 py-2 text-sm hover:border-[#6B7D3A]"
          >
            Back
          </Link>
          <button
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-3">
        <div className="rounded-lg border border-sky-300 bg-sky-100 p-4 lg:col-span-1">
          <div className="flex gap-4">
            <div className="h-20 w-20 overflow-hidden rounded border border-sky-300 bg-sky-100">
            ...
            <div className="min-w-0">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <span className="rounded-full bg-[#9fcffc] px-2 py-1 text-xs text-[#080c12] ring-1 ring-[#2A3A30]">
                  Rank: <span className="text-[#E6EAE7]">{soldier.rank}</span>
                </span>
                <span className="rounded-full bg-[#9fcffc] px-2 py-1 text-xs text-[#080c12] ring-1 ring-[#2A3A30]">
                  Unit: <span className="text-[#E6EAE7]">{soldier.unitId}</span>
                </span>
              </div>
          ...
          <div className="mt-4 rounded-md border border-sky-300 bg-sky-100 p-3">
        ...
        <div className="rounded-lg border border-sky-300 bg-sky-100 p-4 lg:col-span-2">
          ...
          <div className="mt-5">
            ...
            <div className="mt-2 grid gap-2">
              {soldierProofs.map((p) => (
                <div
                  key={p.id}
                  className="flex flex-col gap-1 rounded-md border border-sky-300 bg-sky-100 p-3 sm:flex-row sm:items-center sm:justify-between"
                >
                  <div className="min-w-0">
              ...
              {!soldierProofs.length && (
                <div className="rounded-md border border-sky-300 bg-sky-100 p-3 text-sm text-[#080c12]">
      ...
      {showProof && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
          <div className="w-full max-w-xl rounded-lg border border-sky-300 bg-sky-100">
            <div className="flex items-center justify-between border-b border-[#2A3A30] px-4 py-3">
              ...
              <button
                ...
                className="rounded-md border border-sky-300 bg-sky-100 px-2 py-1 text-xs"
              >
                Close
              </button>
            </div>
            <div className="grid gap-3 px-4 py-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="mt-1 h-24 w-full rounded-md border border-sky-300 bg-sky-100 px-3 py-2 text-sm outline-none focus:border-[#6B7D3A]"
